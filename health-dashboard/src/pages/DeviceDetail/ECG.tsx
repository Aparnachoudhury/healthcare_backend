...
const ECG = (_props: Props) => (
  <div>
    ...
    <div style={{ background: "#fff5f5", border: "1px solid #ffccc7", borderRadius: "8px", padding: "40px", textAlign: "center", color: "#ff4d4f", marginBottom: "16px" }}>No data</div>
    <div style={{ background: "#e6f7ff", borderRadius: "6px", padding: "12px", fontSize: "12px", color: "#1890ff", marginBottom: "16px" }}>
      ℹ AI analysis results are given by the IWOWN Intelligent Diagnosis department (database for reference only).
    </div>
