          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
            <thead>
              <tr style={{ background: '#F0FDF4' }}>
                {['Serial number','Nickname','Device ID','Alarm type','Alarm time',
                  'Geographic location','Alarm content','Device homepage'].map(h => (
                  <th key={h} style={{
                    padding: '11px 13px', textAlign: 'left', fontWeight: 600,
                    fontSize: '12px', color: '#065F46', whiteSpace: 'nowrap',
              ...
              {!loading && alarms.map((a, i) => (
                ...
                >
                  ...
                  <td style={{ padding: '12px 13px' }}>
                    <span style={{ ...typeBadge(a.type), padding: '3px 10px', borderRadius: '12px', fontSize: '12px', fontWeight: 600 }}>
                      {a.type}
                    </span>
                  </td>
