...
const Topbar = () => {
  ...
  return (
    <div style={{ height: "56px", background: "#ffffff", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px", flexShrink: 0 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "6px", background: "#F0FDF4", border: "1px solid #BBF7D0", borderRadius: "20px", padding: "5px 14px", fontSize: "12px", color: "#065F46", fontWeight: 500 }}>
        ...
        <div style={{ width: "34px", height: "34px", borderRadius: "50%", background: "#D1FAE5", border: "2px solid #10B981", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", fontWeight: 700, color: "#065F46", cursor: "pointer" }}>AS</div>
      </div>
    </div>
  );
};
